using Decal.Adapter;
using JCDecalTools.Lib;
using System;
using System.Collections.Generic;
using System.IO;
using System.Reflection;

namespace JCDecalTools
{
    [FriendlyName("JCDecalTools")]
    public class JCDecalTools : FilterBase
    {
        ...
        /// </summary>
        public static string PluginAssemblyNamespace { get { return "JCDecalToolsPlugin.JCDecalToolsPlugin"; } }

        /// <summary>
        /// File name of the plugin we want to hot reload
        /// </summary>
        public static string PluginAssemblyName { get { return "JCDecalToolsPlugin.dll"; } }
        ...
        public static string PluginAssemblyDirectory
        {
            get
            {
                return System.IO.Path.GetDirectoryName(Assembly.GetAssembly(typeof(JCDecalTools)).Location);
            }
        }
